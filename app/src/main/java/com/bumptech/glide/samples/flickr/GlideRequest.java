...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
  ...
  /**
   * @see GlideOptions#squareMiniThumb()
   */
  @CheckResult
  @NonNull
  public GlideRequest<TranscodeType> squareMiniThumb() {
    if (getMutableOptions() instanceof GlideOptions) {
      this.requestOptions = ((GlideOptions) getMutableOptions()).squareMiniThumb();
    } else {
      this.requestOptions = new GlideOptions().apply(this.requestOptions).squareMiniThumb();
    }
    return this;
  }
